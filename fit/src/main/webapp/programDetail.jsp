  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8">
        <article class="post">
	        <div class="card">
	    		<div class="card-body"><h1>프로그램명 </h1></div>
	  		</div>
         <br/>
 		<div class="card">
          ...
          <div class="post-content">
           <br/>    
          	<div class="card">
            <p>프로그램 설명 sunt in culpa qui officia deserunt mollit anim id est laborum.
      ...
      <div class="col-lg-4">
        ...
        <div class="card" style="width:359px">
		  <div class="card-body text-center">
		    <a href="#" class="btn btn-outline-primary">예약가능인원</a><br/><br/>
		    <a href="#" class="btn btn-outline-primary">위시리스트 담기</a><br/><br/>
		    <a href="#" class="btn btn-outline-primary">등록</a><br/>
		  </div>
		</div>
