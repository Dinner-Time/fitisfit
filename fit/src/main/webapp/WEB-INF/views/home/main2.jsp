			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="moreRegion row text-center">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Ulsan.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">울산</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Busan.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">부산</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Gwangju.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">광주</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Gyeonggi.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">경기</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
					...
					<div class="moreRegion row text-center">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Gangwon.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">강원</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Chungcheong.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">충청</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Gyeongsang.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">경상</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Jeolla.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">전라</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
						<!-- END COL -->
					...
					<div class="moreRegion row text-center">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="service-item"
								style="background: url('images/region/Jeju.jpg');">
								<div class="filter"></div>
								<p class="reg-cat-title">제주</p>
								<p class="reg-cat-detail">XX여 개의 센터</p>
							</div>
						</div>
					</div>
