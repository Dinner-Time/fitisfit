						...
						<div class="card-body">
							<c:if test="${member.memPhoto != null }">
								<img class="card-img-top img-thumbnail"
									src="images/member/${member.memPhoto }" alt="member image"
									style="width: 100%">
							</c:if>
							<c:if test="${member.memPhoto == null}">
								<img class="card-img-top img-thumbnail"
					...
					<article class="post">
						<div class="card">
							<div class="card-header">
								<h1>Ronnie & Steve PT</h1>
							</div>
							<div class="card-body">
								<p>LA 출신 해외파 트레이너 쌤들의 Health Training</p>
							</div>
						</div>
						<br />
						<!-- Post Content -->
						<div class="post-content">
							<div class="card">
								<div class="card-body">
									<div class="custom-border">
										<ul class="checklist">
											<li class="list" style="color: gray;">카테고리 : 헬스</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="custom-border">
										<ul class="checklist">
											<li class="list" style="color: gray;">강사 : Ronnie, Steve</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="custom-border">
										<ul class="checklist">
											<li class="list" style="color: gray;">업체 : GYM PITI</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="custom-border">
										<ul class="checklist">
											<li class="list" style="color: gray;">기간 : 상설</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="custom-border">
										<ul class="checklist">
											<li class="list" style="color: gray;">등록인원 : 0 / 20</li>
										</ul>
									</div>
								</div>
							</div>
