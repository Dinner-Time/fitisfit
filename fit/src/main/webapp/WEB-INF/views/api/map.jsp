				...
				<section class="about-2 section" id="about">
					<div class="container">
						<div class="row">
							...
							<div class="col-12">
								<img src="images/partner/gymPictogram.jpg" id="partnerPhoto" class="img-fluid" alt="" style="height: 30vh;">
							</div>
							<div class="col-12">
		...
		navigator.geolocation.getCurrentPosition(function (position) {
			...
			naver.maps.Event.addListener(currentMarker, 'click', function (e) {
				$(partners).hide('slow', function () {
					...
					$(partners).find('#partnerPhoto').attr('src', 'images/partner/gymPictogram.jpg');
			...
			naver.maps.Service.geocode({
				...
				naver.maps.Event.addListener(marker, 'click', function (e) {
					$(partners).hide('slow', function () {
						...
						$(partners).find('#partnerPhoto').attr('src', 'images/partner/'+ parPhoto);
