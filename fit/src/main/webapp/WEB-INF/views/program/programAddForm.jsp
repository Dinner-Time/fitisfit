				...
				<div class="col-md-4" align="center">
					<div class="card" style="width: 300px">
						<img class="card-img-top img-thumbnail"
							src="images/program/generalProgram.jpg" alt="program image" style="width: 100%">
					...
					<table class="table">
						<tr>
							...
							<td><input type="text" id="proName" name="proName" 
								class="form-control" placeholder="프로그램명을 입력해주세요" required="required"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="date" id="proSince" name="proSince" class="form-control" required="required"></td>
						</tr>
						<tr>
							<th width=240px; height=70px;>기간 (월)<br>
							<p class="text-muted">(상설프로그램은 0으로 합니다.)</p></th>
							<td><input type="number" id="proPeriod" name="proPeriod" class="form-control" 
								value="0" required="required"></td>
						</tr>
						<tr>
							<th width=240px; height=70px;>1달권 가격 (원)</th>
							<td><input type="number" id="proPrice" name="proPrice" class="form-control" required="required"></td>
						</tr>
						<tr>
							<th width=240px; height=70px;>2달권 할인율 (%)</th>
							<td><input type="number" id="proSale2" name="proSale2" class="form-control" required="required"></td>
						</tr>
						<tr>
							<th width=240px; height=70px;>3달 이상 할인율 (%)</th>
							<td><input type="number" id="proSale3" name="proSale3" class="form-control" required="required"></td>
						</tr>
						<tr>
							<th width=240px; height=70px;>최대 인원 (명)</th>
							<td><input type="number" id="proMaxPeople" name="proMaxPeople" class="form-control" required="required"></td>
						</tr>
						<tr>
