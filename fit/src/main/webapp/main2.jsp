...
$("#toggle-btn").click(function() {
	if ($("#more-region").css("display") == "none") {
		$("#more-region").show();
	} else {
		$("#more-region").hide();
	}
...
$(document).ready(function() {
	let contents = $('div.col-md3 col-sm-6 col-xs-12');
	let imgUrl = "images/region/"+ "Seoul.jpg";
				...
				<!-- START ROW -->
					...
					<c:forEach var="region" items="${regList}">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div id="regionCard" class="service-item">
								<div class="filter"></div>
								<p class="reg-cat-title">${region.regName}</p>
								<p class="reg-cat-detail">${region.proByReg}개의 센터</p>
							</div>
						</div>
					</c:forEach>
					...
					<div align="center">
						<button type="button" id="toggle-btn" class="btn btn-main mt-20">더보기</button>
						
					<!-- START ROW -->
						<div id="more-region" class="row text-center">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="service-item" style="background: url('images/region/Seoul.jpg');">
									<div class="filter"></div>
									<p class="reg-cat-title">서울</p>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<c:forEach var="category" items="${catList}">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div id="categoryCard" class="service-item">
								<div class="filter"></div>
								<p class="reg-cat-title">${category.catName}</p>
								<p class="reg-cat-detail">${category.proByCat}개의 센터</p>
							</div>
						</div>
					</c:forEach>
