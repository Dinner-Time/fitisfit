		...
		<div class="row">
			...
			<div class="col-12">
				<div class="title text-center ">
					<h2> Program <span class="color">List</span></h2>
			...
			<article class="col-md-3 col-sm-6 col-xs-12 clearfix ">
				<div class="post-item">
					...
					<div class="content">
						...
						<a class="btn btn-main" href="single-post.html">가격</a>
					</div>
				</div>
			</article>
			<!-- /single blog post -->
			...
			<article class="col-md-3 col-sm-6 col-xs-12 ">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="single-post.html">요가</a></h3>
						<p>간략 설명</p>
						<p>2021-08-17 - 2022-08-16</p>
						<a class="btn btn-main" href="single-post.html">가격</a>
					</div>
			...
			<article class="col-md-3 col-sm-6 col-xs-12 ">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="single-post.html">필라테스</a></h3>
						<p>간략 설명</p>
						<p>2021-08-17 - 2022-08-16</p>
						<a class="btn btn-main" href="single-post.html">가격</a>
					</div>
			...
			<article class="col-md-3 col-sm-6 col-xs-12 ">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="single-post.html">수영</a></h3>
						<p>간략 설명</p>
						<p>2021-08-17 - 2022-08-16</p>
						<a class="btn btn-main" href="single-post.html">가격</a>
					</div>
